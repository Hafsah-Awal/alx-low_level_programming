...
/**
 * check97 -The number of arguments checked
...
/**
 * check98 - number of checks that file_from exists and can be read
 * @check: checks whether it is true of false
 * @file: file_from name
...
/**
 * main - The main copies the content of a file to another file.
