 ...
 * @e_ident: An array pointing to a number  containing the ELF magic numbers.
 *
 ...
 * @e_ident: pointer that points to an array containing the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
	printf("  OS/ABI:                            ");
 ...
 * @e_ident: pointer that points to an array containing the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
